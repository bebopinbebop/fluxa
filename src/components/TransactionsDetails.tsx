...
export function TransactionsDetails() {
  const { transactions, transactionsLoading } = useAuth();
      ...
      ListHeaderComponent={
        <View style={styles.header}>
          ...
          <View style={styles.dateRow}>
            <TextInput value={fromDate} onChangeText={setFromDate} style={[styles.input, styles.dateInput]} />
            <TextInput value={toDate} onChangeText={setToDate} style={[styles.input, styles.dateInput]} />
          </View>
